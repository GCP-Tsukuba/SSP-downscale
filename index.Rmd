...
[please click here: tiff and csv files](https://www.dropbox.com/sh/d598disl4v97tnn/AAAnZmMCY61PcLLEdNsXgW4Ta?dl=0)

And also, you can download 3D globemap html files on the five SSPs (2000-2100) from the link below.

[please click here: 3D globemaps](https://www.dropbox.com/sh/qw8h02vd33hcl1p/AADUciV3ldCJMriHnVoU6qlpa?dl=0)

## References
- Daisuke Murakami, Yoshiki Yamagata, Takahiro Yoshida (202X) Gridded GDP projections compatible with the five SSPs (Shared Socioeconomic Pathways). Submitted to *Nature Scientific Data*. 
